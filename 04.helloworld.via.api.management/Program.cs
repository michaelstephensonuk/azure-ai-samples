...
var deploymentName = "APIM-Proxy-To-Model";
...
var appSource = new ActivitySource("helloworld-logging-via-apim");

var resource = ResourceBuilder.CreateDefault()
    .AddService("helloworld-logging-via-apim");

using var tracerProvider = Sdk.CreateTracerProviderBuilder()
    .SetResourceBuilder(resource)
    .SetSampler(new AlwaysOnSampler())
    .AddSource("helloworld-logging-via-apim")
...
using (var operation = appSource.StartActivity("run-ai-prompt-via-apim", ActivityKind.Server))
{
